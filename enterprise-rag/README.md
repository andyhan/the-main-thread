...
**Tutorial:** step-by-step Markdown for this demo lives in [article.md](article.md). The published version is on The Main Thread: <https://www.the-main-thread.com/p/enterprise-rag-quarkus-docling-pgvector-tutorial>.
